...
class Video(Gtk.HBox):
    ...
    def __init__(self):
        ...
        self.video_description_box = Gtk.Box()
        self.video_description_label = Gtk.Label("Video description")
        self.video_description_label.set_line_wrap(True)
        self.video_author_label = Gtk.Label("Author: -")
        self.video_description_box.add(self.video_description_label)
        swin = Gtk.ScrolledWindow()
        swin.add_with_viewport(self.video_description_box)
        self.left_vbox.pack_start(self.video_title, False, False, 10)
        self.left_vbox.pack_start(self.image, False, False, 10)
        self.left_vbox.pack_start(self.video_author_label, False, False, 8)
        self.left_vbox.pack_start(swin, True, True, 10)
        self.pack_start(self.left_vbox, False, False, 5)
